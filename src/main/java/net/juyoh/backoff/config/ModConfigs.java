...
public class ModConfigs {
    ...
    public static ConfigClient client() { return client; }
    ...
    public static void register(ModLoadingContext context, ModContainer container) {
        server = register(ConfigServer::new, ModConfig.Type.SERVER);
        client = register(ConfigClient::new, ModConfig.Type.CLIENT);
